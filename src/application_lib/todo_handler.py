...
def render_todo(frame_right,data,username):
    ...
    for i in range(len(data)):
        ...
        button_3 = customtkinter.CTkButton(master=frame_info,
                                           text="Delete",
                                           fg_color=("gray30"),
                                           command=lambda frame_info=frame_info,frames=frames,data=data,frame_right=frame_right,username=username: button_event(frame_info,frames,data,frame_right,username))
